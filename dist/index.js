...
var bitcoin15 = __toESM(require("bitcoinjs-lib"));
...
var LaserEyesContext = (0, import_react12.createContext)(initialWalletContext222222222222);
var LaserEyesContext2 = (0, import_react11.createContext)(initialWalletContext22222222222);
var LaserEyesContext3 = (0, import_react10.createContext)(initialWalletContext2222222222);
var LaserEyesContext4 = (0, import_react9.createContext)(initialWalletContext222222222);
var LaserEyesContext5 = (0, import_react8.createContext)(initialWalletContext22222222);
var LaserEyesContext6 = (0, import_react7.createContext)(initialWalletContext2222222);
var LaserEyesContext7 = (0, import_react6.createContext)(initialWalletContext222222);
var LaserEyesContext8 = (0, import_react5.createContext)(initialWalletContext22222);
var LaserEyesContext9 = (0, import_react4.createContext)(initialWalletContext2222);
var LaserEyesContext10 = (0, import_react3.createContext)(initialWalletContext222);
var LaserEyesContext11 = (0, import_react2.createContext)(initialWalletContext22);
var LaserEyesContext12 = (0, import_react.createContext)(initialWalletContext2);
...
var LaserEyesContext13 = (0, import_react25.createContext)(initialWalletContext);
var useLaserEyes = () => {
  return (0, import_react25.useContext)(LaserEyesContext13);
};
var LaserEyesProvider = ({
  children,
  config
}) => {
  const selfRef = (0, import_react25.useRef)({
    accounts: []
  });
  const self = selfRef.current;
  const [library, setLibrary] = (0, import_react25.useState)(null);
  const [provider, setProvider] = (0, import_react25.useState)();
  const [isInitializing, setIsInitializing] = (0, import_react25.useState)(true);
  const [connected, setConnected] = (0, import_react25.useState)(false);
  const [isConnecting, setIsConnecting] = (0, import_react25.useState)(false);
  const [accounts, setAccounts] = (0, import_react25.useState)([]);
  const [publicKey, setPublicKey] = (0, import_react25.useState)("");
  const [paymentPublicKey, setPaymentPublicKey] = (0, import_react25.useState)("");
  const [address3, setAddress] = (0, import_react25.useState)("");
  const [paymentAddress, setPaymentAddress] = (0, import_react25.useState)("");
  const [balance, setBalance] = (0, import_react25.useState)();
  const [hasUnisat, setHasUnisat] = (0, import_react25.useState)(false);
  const [hasXverse, setHasXverse] = (0, import_react25.useState)(false);
  const [hasOyl, setHasOyl] = (0, import_react25.useState)(false);
  const [hasMagicEden, setHasMagicEden] = (0, import_react25.useState)(false);
  const [hasOkx, setHasOkx] = (0, import_react25.useState)(false);
  const [hasLeather, setHasLeather] = (0, import_react25.useState)(false);
  const [hasPhantom, setHasPhantom] = (0, import_react25.useState)(false);
  const [hasWizz, setHasWizz] = (0, import_react25.useState)(false);
  const [network, setNetwork] = (0, import_usehooks_ts13.useLocalStorage)("network", MAINNET, {
  ...
  const connectUnisat = (0, import_react25.useCallback)(() => __async(void 0, null, function* () {
    try {
  ...
  const connectXverse = (0, import_react25.useCallback)(() => __async(void 0, null, function* () {
    try {
      ...
      yield (0, import_sats_connect13.getAddress)(getAddressOptions);
      setConnected(true);
    } catch (error) {
      throw error;
    }
  ...
  const connectLeather = (0, import_react25.useCallback)(() => __async(void 0, null, function* () {
    try {
  ...
  const sendBTC = (to, amount) => __async(void 0, null, function* () {
    ...
    try {
      ...
      if (provider === UNISAT) {
        ...
        const response = yield (0, import_sats_connect13.request)("sendTransfer", {
          recipients: [
            {
              address: to,
              amount
        ...
        if (response.status === "success") {
          ...
          if (response.error.code === import_sats_connect13.RpcErrorCode.USER_REJECTION) {
  ...
  const signMessage = (message) => __async(void 0, null, function* () {
    ...
    try {
      ...
      if (provider === UNISAT) {
        ...
        const response = yield (0, import_sats_connect13.request)("signMessage", {
          address: address3,
          message
        });
        if (response.status === "success") {
        ...
        let signedMessage;
        yield (0, import_sats_connect13.signMessage)({
          getProvider: () => __async(void 0, null, function* () {
            return window.magicEden.bitcoin;
          }),
          payload: {
            network: {
              type: import_sats_connect13.BitcoinNetworkType.Mainnet
            },
            address: paymentAddress,
            message
          },
      ...
      if (provider === UNISAT) {
        ...
        try {
          for (var iter = __forAwait(inputs), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
            ...
            const addressFromScript = (0, import_address13.fromOutputScript)(
              script,
              getBitcoinNetwork(network)
            );
        ...
        yield (0, import_sats_connect13.signTransaction)(signPsbtOptions);
        return {
          signedPsbtHex,
          signedPsbtBase64,
          txId
  ...
  const pushPsbt = (psbt) => __async(void 0, null, function* () {
    try {
      ...
      if (provider === UNISAT) {
        ...
        return yield import_axios38.default.post(`${getMempoolSpaceUrl3(network)}/api/tx`, psbt).then((res) => res.data);
      } else if (provider === LEATHER) {
        const decoded = bitcoin15.Psbt.fromHex(psbt);
        const extracted = decoded.extractTransaction();
        return yield import_axios38.default.post(`${getMempoolSpaceUrl3(network)}/api/tx`, extracted.toHex()).then((res) => res.data);
      } else if (provider === WIZZ) {
        return yield library == null ? void 0 : library.pushPsbt(psbt);
      } else {
        throw new Error("The connected wallet doesn't support this method..");
...
var useInscriber = ({
  ...
  const [mimeType, setMimeType] = (0, import_react26.useState)(MIME_TYPE_TEXT);
  const [commitPsbtHex, setCommitPsbtHex] = (0, import_react26.useState)("");
  const [commitPsbtBase64, setCommitPsbtBase64] = (0, import_react26.useState)("");
  const [commitTxId, setCommitTxId] = (0, import_react26.useState)("");
  const [feeRate, setFeeRate] = (0, import_react26.useState)(10);
  const [totalFees, setTotalFees] = (0, import_react26.useState)(0);
  const [inscriberAddress, setInscriberAddress] = (0, import_react26.useState)("");
  const [inscriptionTxId, setInscriptionTxId] = (0, import_react26.useState)("");
  const [previewUrl, setPreviewUrl] = (0, import_react26.useState)("");
  const [isFetchingCommitPsbt, setIsFetchingCommitPsbt] = (0, import_react26.useState)(false);
  const [isInscribing, setIsInscribing] = (0, import_react26.useState)(false);
  (0, import_react26.useEffect)(() => {
    setCommitPsbtHex("");
    setCommitPsbtBase64("");
    setCommitTxId("");
  }, [content, address3, mimeType, feeRate]);
  const getCommitPsbt = (0, import_react26.useCallback)(() => __async(void 0, null, function* () {
    try {
      if (!content)
      ...
      return yield import_axios39.default.post(`${inscribeApiUrl}/create-inscription`, {
        content,
        paymentAddress,
        paymentPublicKey,
        feeRate,
  ...
  const inscribe = (0, import_react26.useCallback)(
    (_0) => __async(void 0, [_0], function* ({
      ...
      try {
        ...
        return yield import_axios39.default.post(`${inscribeApiUrl}/inscribe`, {
          content,
          mimeType,
