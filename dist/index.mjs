...
var LaserEyesContext = createContext(initialWalletContext222222222222222222222);
var LaserEyesContext2 = createContext2(initialWalletContext22222222222222222222);
var LaserEyesContext3 = createContext3(initialWalletContext2222222222222222222);
var LaserEyesContext4 = createContext4(initialWalletContext222222222222222222);
var LaserEyesContext5 = createContext5(initialWalletContext22222222222222222);
var LaserEyesContext6 = createContext6(initialWalletContext2222222222222222);
var LaserEyesContext7 = createContext7(initialWalletContext222222222222222);
var LaserEyesContext8 = createContext8(initialWalletContext22222222222222);
var LaserEyesContext9 = createContext9(initialWalletContext2222222222222);
var LaserEyesContext10 = createContext10(initialWalletContext222222222222);
var LaserEyesContext11 = createContext11(initialWalletContext22222222222);
var LaserEyesContext12 = createContext12(initialWalletContext2222222222);
var LaserEyesContext13 = createContext13(initialWalletContext222222222);
var LaserEyesContext14 = createContext14(initialWalletContext22222222);
var LaserEyesContext15 = createContext15(initialWalletContext2222222);
var LaserEyesContext16 = createContext16(initialWalletContext222222);
var LaserEyesContext17 = createContext17(initialWalletContext22222);
var LaserEyesContext18 = createContext18(initialWalletContext2222);
var LaserEyesContext19 = createContext19(initialWalletContext222);
var LaserEyesContext20 = createContext20(initialWalletContext22);
var LaserEyesContext21 = createContext21(initialWalletContext2);
...
var LaserEyesContext22 = createContext22(initialWalletContext);
var useLaserEyes = () => {
  return useContext22(LaserEyesContext22);
};
var LaserEyesProvider = ({
  children,
  config
}) => {
  const selfRef = useRef22({
    accounts: []
  });
  const self = selfRef.current;
  const [library, setLibrary] = useState43(null);
  const [provider, setProvider] = useState43();
  const [isInitializing, setIsInitializing] = useState43(true);
  const [connected, setConnected] = useState43(false);
  const [isConnecting, setIsConnecting] = useState43(false);
  const [accounts, setAccounts] = useState43([]);
  const [publicKey, setPublicKey] = useState43("");
  const [paymentPublicKey, setPaymentPublicKey] = useState43("");
  const [address3, setAddress] = useState43("");
  const [paymentAddress, setPaymentAddress] = useState43("");
  const [balance, setBalance] = useState43();
  const [hasUnisat, setHasUnisat] = useState43(false);
  const [hasXverse, setHasXverse] = useState43(false);
  const [hasOyl, setHasOyl] = useState43(false);
  const [hasMagicEden, setHasMagicEden] = useState43(false);
  const [hasOkx, setHasOkx] = useState43(false);
  const [hasLeather, setHasLeather] = useState43(false);
  const [hasPhantom, setHasPhantom] = useState43(false);
  const [hasWizz, setHasWizz] = useState43(false);
  const [network, setNetwork] = useLocalStorage22("network", MAINNET, {
  ...
  const connectUnisat = useCallback43(() => __async(void 0, null, function* () {
    try {
  ...
  const connectXverse = useCallback43(() => __async(void 0, null, function* () {
    try {
      ...
      yield getAddress22(getAddressOptions);
      setConnected(true);
    } catch (error) {
      throw error;
    }
  ...
  const connectLeather = useCallback43(() => __async(void 0, null, function* () {
    try {
  ...
  const sendBTC = (to, amount) => __async(void 0, null, function* () {
    ...
    try {
      ...
      if (provider === UNISAT) {
        ...
        const response = yield request22("sendTransfer", {
          recipients: [
            {
              address: to,
              amount
        ...
        if (response.status === "success") {
          ...
          if (response.error.code === RpcErrorCode22.USER_REJECTION) {
  ...
  const signMessage = (message) => __async(void 0, null, function* () {
    ...
    try {
      ...
      if (provider === UNISAT) {
        ...
        const response = yield request22("signMessage", {
          address: address3,
          message
        });
        if (response.status === "success") {
        ...
        let signedMessage;
        yield signMessageSatsConnect22({
          getProvider: () => __async(void 0, null, function* () {
            return window.magicEden.bitcoin;
          }),
          payload: {
            network: {
              type: BitcoinNetworkType22.Mainnet
            },
            address: paymentAddress,
            message
          },
      ...
      if (provider === UNISAT) {
        ...
        try {
          for (var iter = __forAwait(inputs), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
            ...
            const addressFromScript = fromOutputScript22(
              script,
              getBitcoinNetwork(network)
            );
        ...
        yield signTransaction22(signPsbtOptions);
        return {
          signedPsbtHex,
          signedPsbtBase64,
          txId
  ...
  const pushPsbt = (psbt) => __async(void 0, null, function* () {
    try {
      ...
      if (provider === UNISAT) {
        ...
        return yield axios45.post(`${getMempoolSpaceUrl3(network)}/api/tx`, psbt).then((res) => res.data);
      } else if (provider === LEATHER) {
        const decoded = bitcoin25.Psbt.fromHex(psbt);
        const extracted = decoded.extractTransaction();
        return yield axios45.post(`${getMempoolSpaceUrl3(network)}/api/tx`, extracted.toHex()).then((res) => res.data);
      } else if (provider === WIZZ) {
        return yield library == null ? void 0 : library.pushPsbt(psbt);
      } else {
        throw new Error("The connected wallet doesn't support this method..");
...
var useInscriber = ({
  ...
  const [content, setContent] = useState44("");
  const [mimeType, setMimeType] = useState44(MIME_TYPE_TEXT);
  const [commitPsbtHex, setCommitPsbtHex] = useState44("");
  const [commitPsbtBase64, setCommitPsbtBase64] = useState44("");
  const [commitTxId, setCommitTxId] = useState44("");
  const [feeRate, setFeeRate] = useState44(10);
  const [totalFees, setTotalFees] = useState44(0);
  const [inscriberAddress, setInscriberAddress] = useState44("");
  const [inscriptionTxId, setInscriptionTxId] = useState44("");
  const [previewUrl, setPreviewUrl] = useState44("");
  const [isFetchingCommitPsbt, setIsFetchingCommitPsbt] = useState44(false);
  const [isInscribing, setIsInscribing] = useState44(false);
  useEffect44(() => {
    setCommitPsbtHex("");
    setCommitPsbtBase64("");
    setCommitTxId("");
  }, [content, address3, mimeType, feeRate]);
  const getCommitPsbt = useCallback44(() => __async(void 0, null, function* () {
    try {
      if (!content)
      ...
      return yield axios46.post(`${inscribeApiUrl}/create-inscription`, {
        content,
        paymentAddress,
        paymentPublicKey,
        feeRate,
  ...
  const inscribe = useCallback44(
    (_0) => __async(void 0, [_0], function* ({
      ...
      try {
        ...
        return yield axios46.post(`${inscribeApiUrl}/inscribe`, {
          content,
          mimeType,
...
var LeatherLogo = (_a) => {
  ...
  if (variant === "first") {
    return /* @__PURE__ */ jsxs34(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          /* @__PURE__ */ jsx60("rect", { width: "128", height: "128", rx: "26.8387", fill: "#12100F" }),
          /* @__PURE__ */ jsx60(
            "path",
            {
  ...
  return /* @__PURE__ */ jsxs34(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx60("rect", { width: "128", height: "128", rx: "26.8387", fill: "#F5F1ED" }),
        /* @__PURE__ */ jsx60(
          "path",
          {
  ...
  if (variant === "first") {
    return /* @__PURE__ */ jsxs35(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          /* @__PURE__ */ jsxs35("g", { clipPath: "url(#a)", children: [
            /* @__PURE__ */ jsx61(
              "path",
              {
                fill: "#AB9FF2",
          ...
          /* @__PURE__ */ jsx61("defs", { children: /* @__PURE__ */ jsx61("clipPath", { id: "a", children: /* @__PURE__ */ jsx61("path", { fill: "#fff", d: "M0 0h42v42H0z" }) }) })
        ]
      })
    );
  }
...
var XverseLogo = (_a) => {
  ...
  return /* @__PURE__ */ jsxs36(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsxs36("g", { clipPath: "url(#clip0_3_53)", children: [
          /* @__PURE__ */ jsx62(
            "path",
            {
        ...
        /* @__PURE__ */ jsx62("defs", { children: /* @__PURE__ */ jsx62("clipPath", { id: "clip0_3_53", children: /* @__PURE__ */ jsx62("rect", { width: "42", height: "42", fill: "white" }) }) })
      ]
    })
  );
};
        ...
        /* @__PURE__ */ jsxs37("defs", { children: [
          /* @__PURE__ */ jsxs37(
            "linearGradient",
            {
              ...
              children: [
                /* @__PURE__ */ jsx63("stop", { stopColor: "#201C1B" }),
                /* @__PURE__ */ jsx63("stop", { offset: 0.36, stopColor: "#77390D" }),
                /* @__PURE__ */ jsx63("stop", { offset: 0.67, stopColor: "#EA8101" }),
                /* @__PURE__ */ jsx63("stop", { offset: 1, stopColor: "#F4B852" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs37(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ jsx63("stop", { stopColor: "#1F1D1C" }),
                /* @__PURE__ */ jsx63("stop", { offset: 0.37, stopColor: "#77390D" }),
                /* @__PURE__ */ jsx63("stop", { offset: 0.67, stopColor: "#EA8101" }),
                /* @__PURE__ */ jsx63("stop", { offset: 1, stopColor: "#F4FB52" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs37(
            "radialGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ jsx63("stop", { stopColor: "#F4B852" }),
                /* @__PURE__ */ jsx63("stop", { offset: 0.33, stopColor: "#EA8101" }),
                /* @__PURE__ */ jsx63("stop", { offset: 0.64, stopColor: "#77390D" }),
                /* @__PURE__ */ jsx63("stop", { offset: 1, stopColor: "#211C1D" })
              ]
            }
          ),
          /* @__PURE__ */ jsx63("clipPath", { id: "a", children: /* @__PURE__ */ jsx63("path", { fill: "#fff", d: "M0 0h42v42H0z" }) })
        ] })
      ]
    })
  );
...
var WizzLogo = (_a) => {
  ...
  return /* @__PURE__ */ jsxs38(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsxs38("g", { clipPath: "url(#a)", children: [
          /* @__PURE__ */ jsx64(
            "path",
            {
              fill: "#000",
          ...
          /* @__PURE__ */ jsxs38("g", { fillRule: "evenodd", clipPath: "url(#b)", clipRule: "evenodd", children: [
            /* @__PURE__ */ jsx64(
              "path",
              {
                fill: "#FFD815",
        ...
        /* @__PURE__ */ jsxs38("defs", { children: [
          /* @__PURE__ */ jsx64("clipPath", { id: "a", children: /* @__PURE__ */ jsx64("path", { fill: "#fff", d: "M0 0h42v42H0z" }) }),
          /* @__PURE__ */ jsx64("clipPath", { id: "b", children: /* @__PURE__ */ jsx64("path", { fill: "#fff", d: "M8 8h25v25H8z" }) })
        ] })
      ]
    })
  );
...
var OkxLogo = (_a) => {
  ...
  return /* @__PURE__ */ jsxs39(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsxs39("g", { clipPath: "url(#a)", children: [
          /* @__PURE__ */ jsx65(
            "path",
            {
              fill: "#000",
...
var MagicEdenLogo = (_a) => {
  ...
  return /* @__PURE__ */ jsxs40(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsxs40("g", { clipPath: "url(#clip0_17_93)", children: [
          /* @__PURE__ */ jsx66(
            "path",
            {
              fill: "#070C34",
        ...
        /* @__PURE__ */ jsxs40("defs", { children: [
          /* @__PURE__ */ jsxs40(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ jsx66("stop", { offset: "0.23", stopColor: "#FF0074" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.26", stopColor: "#FF0068" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.32", stopColor: "#FF0048" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.39", stopColor: "#FF0015" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.41", stopColor: "#FF0009" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.43", stopColor: "#FF0908" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.54", stopColor: "#FF4003" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.62", stopColor: "#FF6201" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.66", stopColor: "#FF6F00" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.72", stopColor: "#FF8700" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.83", stopColor: "#FFAB00" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.92", stopColor: "#FFC100" }),
                /* @__PURE__ */ jsx66("stop", { offset: "0.98", stopColor: "#FFCA00" })
              ]
            }
          ),
          /* @__PURE__ */ jsx66("clipPath", { id: "clip0_17_93", children: /* @__PURE__ */ jsx66("path", { fill: "#fff", d: "M0 0h42v42H0z" }) })
        ] })
      ]
    })
  );
...
var WalletIcon = ({
  ...
  if (walletName === XVERSE) {
    return /* @__PURE__ */ jsx67(XverseLogo, { size, className, variant });
  } else if (walletName === WIZZ) {
    return /* @__PURE__ */ jsx67(WizzLogo, { size, className, variant });
  } else if (walletName === LEATHER) {
    return /* @__PURE__ */ jsx67(LeatherLogo, { size, className, variant });
  } else if (walletName === MAGIC_EDEN) {
    return /* @__PURE__ */ jsx67(MagicEdenLogo, { size, className, variant });
  } else if (walletName === OKX) {
    return /* @__PURE__ */ jsx67(OkxLogo, { size, className, variant });
  } else if (walletName === PHANTOM) {
    return /* @__PURE__ */ jsx67(PhantomLogo, { size, className, variant });
  } else if (walletName === UNISAT) {
    return /* @__PURE__ */ jsx67(UnisatLogo, { size, className, variant });
  } else if (walletName === OYL) {
    return /* @__PURE__ */ jsx67(OylLogo, { size, className, variant });
  } else {
    return /* @__PURE__ */ jsx67(LeatherLogo, { size, className, variant });
  }
};
